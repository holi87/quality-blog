...
|-----------|-----------|-----------|--------------|
| Claude Code | tak (jako fallback) | **główny** | nie |
...
### Opcja 2: jeden plik z headerami per narzędzie
...
### Opcja 3: trzy oddzielne pliki + cross-link
...
## Anti-pattern: kopia 1:1 między plikami
...
**Wyjście:** dodaj do retro pytanie *„czy CLAUDE.md zgadza się z tym, jak teraz pracujemy?"*. Każda zmiana w workflow = PR do pliku.
