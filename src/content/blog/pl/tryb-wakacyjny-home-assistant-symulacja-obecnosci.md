...
Włamywacze nie obserwują domów przez lornetki całą dobę, ale ciemne okna wieczór w wieczór przez tydzień to sygnał czytelny dla każdego, kto regularnie przechodzi obok. Symulacja obecności ma jeden cel: z zewnątrz dom ma wyglądać na zamieszkany. I tu pierwsza pułapka, w którą sam wpadłem: idealnie regularna symulacja zdradza pustkę równie skutecznie jak ciemne okna. Światło w salonie zapalające się codziennie o 19:00:00 i gasnące o 22:30:00 co do sekundy to podpis programatora czasowego, nie człowieka. Ludzie są nieregularni - i tę nieregularność trzeba odtworzyć. Dobra wiadomość: nie musisz symulować całego domu. Wystarczą pomieszczenia widoczne z ulicy i z podwórka - u mnie salon, sypialnia i łazienka; piwnicy nikt z zewnątrz nie ocenia.
...
Symulacja to teatr na zewnątrz; do środka dom patrzy czujkami. Zestaw jest standardowy - czujniki otwarcia na oknach i drzwiach, czujniki ruchu, czujniki zalania pod zmywarką, pralką i bojlerem, czujka dymu, kamery - ale podczas urlopu zmieniają się wagi zdarzeń. O warstwowym modelu powiadomień (alarm, informacja, dziennik) pisałem już [w osobnym tekście](/pl/blog/powiadomienia-ktore-nie-mecza-home-assistant/); tryb wakacyjny to w praktyce masowa zmiana przypisań między warstwami. Otwarcie drzwi wejściowych, na co dzień wpis do dziennika, przy uzbrojonym alarmie i pustym domu jest zdarzeniem krytycznym: powiadomienie przebija wyciszenie, a kamera w przedpokoju dokleja do niego zdjęcie (o kamerach i prywatności pisałem [osobno](/pl/blog/ai-smart-home-kamery-prywatnosc/)). Ruch wewnątrz bez wcześniejszego otwarcia drzwi to najwyższy priorytet ze wszystkich, bo oznacza, że w domu jest ktoś, kto nie wszedł drzwiami. Do zestawu warto dorzucić czujnik temperatury z progiem alarmowym: awaria ogrzewania przy pustym domu zimą to pęknięte rury, a latem padnięta lodówka wita cię po powrocie zapachem nie do opisania - oba scenariusze wykrywa jeden tani czujnik i jedna automatyzacja z progiem.

Druga zmiana: eskalacja przestaje być opcją i staje się obowiązkiem, bo nie istnieje plan awaryjny w postaci „zaraz zejdę i sprawdzę". Zalanie przy pustym domu obsługuję w trzech krokach. Powiadomienie krytyczne na mój telefon i zamknięcie elektrozaworu wody natychmiast - dom nie czeka na moją zgodę, bo koszt niepotrzebnie zamkniętego zaworu przy pustym domu jest zerowy. Brak mojego potwierdzenia w pięć minut - powiadomienie na telefon Julii. Brak reakcji od nas obojga - wiadomość do zaufanej osoby z kluczami, z prośbą o sprawdzenie. Zauważ odwrócenie codziennej logiki: normalnie dom pyta, zanim zadziała; przy pustym domu najpierw działa, a potem melduje.
...
Drugi element to podtrzymanie zasilania: UPS na serwer i router kupuje kilkanaście minut, które załatwiają większość krótkich przerw w dostawie prądu, a integracja z UPS daje sensor stanu baterii - powiadomienie „dom działa na baterii", wysłane zanim wszystko zgaśnie, jest warte więcej niż cisza po fakcie. Trzeci: restart bez opieki. Sprawdź przed wyjazdem, że po odcięciu i przywróceniu prądu serwer wstaje sam, Home Assistant startuje bez pytania o cokolwiek, a input_boolean odtwarza stan sprzed restartu (odtwarza - stany encji pomocniczych są zapisywane). I zrób aktualną kopię zapasową z przetestowanym odtwarzaniem - [strategię kopii zapasowych opisałem osobno](/pl/blog/backup-home-assistant-strategia-odtwarzania/); dysk potrafi umrzeć także ósmego dnia urlopu.
...
- **Zawór wody** - jeśli nie masz elektrozaworu, zakręć główny zawór ręcznie; pralka i zmywarka nie potrzebują ciśnienia przez dwa tygodnie.
