...
description: "Number of Releases as a context metric - why a bug count only makes sense relative to the number of releases. Article 6 of 9."
date: 2026-06-23
...
<p class="fb-lead">Three bugs across two releases is a disaster. Three bugs across fifteen - a success. Number of Releases is the metric that gives every other metric its proper context.</p>
...
- Why a bug count means nothing without a release count
- Number of Releases as the denominator for the other metrics
- Examples: 3 bugs / 2 releases vs 3 bugs / 15 releases
...
<div class="fb-series">
  ...
  <ul class="fb-s-list">
    ...
    <li class="fb-s-item fb-s-current"><span class="fb-s-num">06</span><div><div class="fb-s-title">Number of Releases <span class="fb-s-now">you are here</span></div><div class="fb-s-sub">Why 3 bugs with 2 releases is a disaster, and with 15 - a success</div></div></li>
