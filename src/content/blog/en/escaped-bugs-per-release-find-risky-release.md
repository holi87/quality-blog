...
description: "Escaped Bugs per Release - how to pinpoint a specific risky release instead of just watching the trend. Article 5 of 9."
date: 2026-06-16
...
<p class="fb-lead">A trend shows direction. But it's a single release that can be the real source of risk - and this article shows how to pinpoint it, not just observe the effects.</p>
...
- How to tell a general trend from a single risky release
- The investigation method: from a spike in the data to its root cause
...
<div class="fb-series">
  ...
  <ul class="fb-s-list">
    ...
    <li class="fb-s-item fb-s-current"><span class="fb-s-num">05</span><div><div class="fb-s-title">Escaped Bugs per Release <span class="fb-s-now">you are here</span></div><div class="fb-s-sub">Pinpointing problems, not just watching trends</div></div></li>
